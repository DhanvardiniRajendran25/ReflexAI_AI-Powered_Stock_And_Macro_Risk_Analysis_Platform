...
# Silence yfinance FutureWarnings
warnings.filterwarnings("ignore", category=FutureWarning, module="yfinance")


def _to_float(x):
    """
    Converts a pandas Series, numpy value, or scalar into a Python float.
    Handles cases where yfinance returns multi-index data.
    """
    try:
        if hasattr(x, "item"):
            return float(x.item())
